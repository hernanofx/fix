...
export default function PurchaseOrderImportModal({
    isOpen,
    onClose,
    onImportSuccess
}: PurchaseOrderImportModalProps) {
    ...
    const handleUpload = async () => {
        ...
        try {
            ...
            const response = await fetch('/api/providers/orders/import/excel', {
                method: 'POST',
                body: formData
            })
    ...
    return (
        <Modal
            isOpen={isOpen}
            onClose={handleClose}
            title="Importar Órdenes de Pedido"
            size="lg"
        >
                    ...
                    <div className="flex items-start space-x-3">
                        ...
                        <div>
                            ...
                            <Button
                                ...
                                size="sm"
                                className="mt-2"
                                onClick={() => window.open('/api/providers/orders/template', '_blank')}
                            >
                                Descargar Plantilla
                            </Button>
                        </div>
