...
export default function ClientFormModal({ isOpen, onClose, onSave, client, readOnly = false }: ClientFormModalProps) {
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg w-full max-w-2xl mx-4 max-h-[90vh] overflow-y-auto">
                <div className="flex justify-between items-center mb-6">
                    <h3 className="text-lg font-medium text-gray-900">
                        {readOnly ? 'Detalles del Cliente' : (client ? 'Editar Cliente' : 'Crear Cliente')}
                    </h3>
                    <button
                        onClick={onClose}
