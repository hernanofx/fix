...
// Schema for creating prospect notes
const createNoteSchema = z.object({
    title: z.string().optional(),
    content: z.string().min(1),
    type: z.enum(['GENERAL', 'FOLLOW_UP', 'DECISION_MAKER', 'OBJECTION', 'COMPETITION', 'BUDGET', 'TIMELINE']).default('GENERAL'),
...
// GET /api/clients/prospects/[prospectId]/notes
...
// POST /api/clients/prospects/[prospectId]/notes
export async function POST(
    ...
    try {
        ...
        console.error('Error creating prospect note:', error);
        return NextResponse.json(
            { error: 'Internal server error' },
            { status: 500 }
        );
